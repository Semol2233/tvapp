...
class seeearcsssh_filter(APIView, PaginationHandlerMixin):
    ...
    def get(self,request,query):
        result = []
        filter_postmodel_q = Add_Channel.objects.filter(Q(channel_name__iexact=query,channel_name__isnull = False) | Q(catgory__cat_name__iexact=query)).values('id','channel_name','catgory','channel_logo')
