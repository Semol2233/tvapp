...
class seeearcsssh_filter(APIView, PaginationHandlerMixin): 
    ...
    def get(self,request,query):
        result = []
        filter_postmodel_q = Add_Channel.objects.filter(Q(channel_name__search=query) | Q(channel_name__search=query) | Q(catgory__cat_name__search=query)).values('id','channel_name','catgory__cat_name','channel_logo')
