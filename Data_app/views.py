...
class seeearcsssh_filter(APIView, PaginationHandlerMixin): 
    ...
    def get(self,request,query):
        result = []
        filter_postmodel_q = Add_Channel.objects.annotate(search=SearchVector('id','channel_name','straming_url','channel_logo','catgory__cat_name'),).filter(search=query).values('id','channel_name','catgory__cat_name','channel_logo')
